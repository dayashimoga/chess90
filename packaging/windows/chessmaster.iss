...
[Setup]
AppId={{E6F78C53-33C6-4B89-8A1C-1B057D93617A}
AppName={#MyAppName}
...
AllowNoIcons=yes
OutputDir=..\..\dist
OutputBaseFilename=ChessMaster-Setup
...
[Files]
Source: "..\..\dist\windows\ChessMaster\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
