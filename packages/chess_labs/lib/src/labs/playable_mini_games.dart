  ...
  static PlayableMiniGame _buildForkHunter() {
    return PlayableMiniGame(
      ...
      levels: const [
        ...
        MiniGameLevel(
          levelNumber: 3,
          title: 'Back-Rank Decoy Fork',
          initialFen: '4r1k1/5ppp/8/3q4/8/8/5PPP/4N1K1 w - - 0 1',
          sideToPlay: PieceColor.white,
          objective: 'Deliver check on the 8th rank to win the queen.',
          expectedMovesSan: ['Nf3', 'Qxf3', 'gxf3'],
          hints: ['Secure the back rank.', 'Liquidate the overextended queen.'],
          explanation: 'Removing attacking momentum wins material safely.',
        ),
      ],
    );
  }
